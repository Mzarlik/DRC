    ...
    <div id="content">
        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h2 class="fw-bold mb-1"><i class="fa-solid fa-list-ol text-primary me-2"></i> Turnos de Atención</h2>
                    <p class="text-muted small mb-0">Tablero interactivo de control de turnos y llamado en sala de espera</p>
                </div>
                <div class="d-flex gap-2">
                    <a href="../../public/turnos.php" target="_blank" class="btn btn-outline-secondary">
                        <i class="fa-solid fa-tv me-1"></i> Ver pantalla pública
                    </a>
                    <button class="btn btn-primary" id="btnNuevoTurno">
                        <i class="fa-solid fa-plus me-1"></i> Generar Turno
                    </button>
                </div>
            </div>
