...
<head>
    ...
    <title>Registrar Divorcios - ERP DRC</title>
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2>Registrar Nuevo TrÃ¡mite (Divorcios)</h2>
                ...
                <div class="card-body">
                    <form id="mainForm">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="ciudadano_1_id" class="form-label fw-bold">Primer Divorciado</label>
                                <select class="select-citizen" id="ciudadano_1_id" name="ciudadano_1_id" required></select>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="ciudadano_2_id" class="form-label fw-bold">Segundo Divorciado</label>
                                <select class="select-citizen" id="ciudadano_2_id" name="ciudadano_2_id" required></select>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="tipo_divorcio" class="form-label fw-bold">Tipo de Divorcio</label>
                                <select class="form-select" id="tipo_divorcio" name="tipo_divorcio" required>
