...
try {
    ...
    $sql = "SELECT d.id, d.numero_acta, d.tipo_divorcio, d.fecha_registro,
    ...
    $params = [];
    if ($searchValue != '') {
        $searchQuery = " WHERE (d.numero_acta LIKE :search OR c1.nombre LIKE :search OR c1.apellido_paterno LIKE :search OR c2.nombre LIKE :search OR c2.apellido_paterno LIKE :search) ";
