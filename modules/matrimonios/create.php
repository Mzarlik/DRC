    ...
    <div id="content">
        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2>Registrar Nuevo Trámite (Matrimonios)</h2>
                ...
                <div class="card-body">
                    <form id="mainForm">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="regimen_patrimonial" class="form-label fw-bold">Régimen Patrimonial</label>
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status === 'success') {
                        window.location.href = 'index.php?toast=success&msg=' + encodeURIComponent('El trámite se ha registrado exitosamente.');
                    } else {
                        Swal.fire({
                            icon: 'error',
                            title: 'Error',
