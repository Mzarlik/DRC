...
<head>
    ...
    <title>Registrar Matrimonios - ERP DRC</title>
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2>Registrar Nuevo TrÃ¡mite (Matrimonios)</h2>
                ...
                <div class="card-body">
                    <form id="mainForm">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="contrayente_1_id" class="form-label fw-bold">Primer Contrayente</label>
                                <select class="select-citizen" id="contrayente_1_id" name="contrayente_1_id" required></select>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="contrayente_2_id" class="form-label fw-bold">Segundo Contrayente</label>
                                <select class="select-citizen" id="contrayente_2_id" name="contrayente_2_id" required></select>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="regimen_patrimonial" class="form-label fw-bold">RÃ©gimen Patrimonial</label>
                                <select class="form-select" id="regimen_patrimonial" name="regimen_patrimonial" required>
                                    <option value="">Seleccione...</option>
                                    <option value="SOCIEDAD CONYUGAL">SOCIEDAD CONYUGAL</option>
                                    <option value="SEPARACIÃ“N DE BIENES">SEPARACIÃ“N DE BIENES</option>
...
<script>
    $(document).ready(function() {
        // Inicializar TomSelect en selects de ciudadanos
        $(document).on('input', '.text-uppercase-input', function() {
            $(this).val($(this).val().toUpperCase());
        });

        // ConfiguraciÃ³n de Tom Select para ciudadanos
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status === 'success') {
                        window.location.href = 'index.php?toast=success&msg=' + encodeURIComponent('El trÃ¡mite se ha registrado exitosamente.');
                    } else {
                        Swal.fire({
                            icon: 'error',
                            title: 'Error',
