<?php
// modules/matrimonios/export_excel.php
header('Content-Type: application/json; charset=utf-8');
require_once '../../core/Auth.php';
\Core\Auth::checkPermission('permiso_registro_matrimonios');
\Core\Auth::check();
\Core\Auth::checkExport('Matrimonios');
...
try {
    ...
    echo json_encode([
        'status' => 'success',
        'message' => 'La exportación del registro de matrimonios se está generando en segundo plano. Te notificaremos cuando esté listo.'
    ]);
    exit;
