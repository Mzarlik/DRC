...
$current_module = 'reconocimientos';
$path_prefix = '../';
...
<head>
    ...
    <title>Registrar Reconocimientos - ERP DRC</title>
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2>Registrar Nuevo TrÃ¡mite (Reconocimientos)</h2>
                ...
                <div class="card-body">
                    <form id="mainForm">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="reconocido_id" class="form-label fw-bold">Persona Reconocida</label>
                                <select class="select-citizen" id="reconocido_id" name="reconocido_id" required></select>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="reconocedor_id" class="form-label fw-bold">Persona que Reconoce (Progenitor)</label>
                                <select class="select-citizen" id="reconocedor_id" name="reconocedor_id" required></select>
                            </div>
                            <div class="col-md-6 mb-3">
