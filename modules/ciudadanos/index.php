    ...
    <div id="content">
        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h2 class="fw-bold mb-1"><i class="fa-solid fa-users text-primary me-2"></i> Padrón de Ciudadanos</h2>
                    <p class="text-muted small mb-0">Catálogo centralizado de personas registradas y consulta de estado civil y vital</p>
                </div>
                <div class="d-flex gap-2">
                    <button type="button" class="btn btn-outline-secondary" id="btnVerInactivos">
                        <i class="fa-solid fa-eye me-1"></i> Ver inactivos
                    </button>
                    ...
                    <a href="create.php" class="btn btn-primary">
                        <i class="fa-solid fa-user-plus me-1"></i> Registrar Ciudadano
                    </a>
                </div>
            </div>
...
<script>
    $(document).ready(function() {
        ...
        const table = $('#ciudadanosTable').DataTable({
            "processing": true,
            "serverSide": true,
            "ajax": {
                "url": "data.php",
