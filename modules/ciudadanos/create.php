...
<head>
    ...
    <title>Registrar Ciudadano - ERP DRC</title>
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h2 class="fw-bold mb-1"><i class="fa-solid fa-user-plus text-success me-2"></i> Registrar Nuevo Ciudadano</h2>
                    <p class="text-muted small mb-0">Alta en el padrón poblacional con cifrado biométrico LGPDPPSO</p>
                </div>
                    ...
                    <form id="formCiudadano">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control text-uppercase-input" id="nombre" name="nombre" required>
                            </div>
                            <div class="col-md-4">
                                <label for="apellido_paterno" class="form-label fw-bold">Apellido Paterno</label>
                                <input type="text" class="form-control text-uppercase-input" id="apellido_paterno" name="apellido_paterno" required>
                            </div>
                            <div class="col-md-4">
                                <label for="apellido_materno" class="form-label fw-bold">Apellido Materno</label>
                                <input type="text" class="form-control text-uppercase-input" id="apellido_materno" name="apellido_materno">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control text-uppercase-input" id="curp" name="curp" maxlength="18">
                                <div class="form-text">Si no cuenta con CURP, déjelo en blanco.</div>
                            </div>
                            <div class="col-md-4">
                        ...
                        <div class="text-end mt-4">
                            <button type="submit" class="btn btn-success" style="background: var(--secondary-color); border: none;">
                                <i class="fa-solid fa-save"></i> Guardar Ciudadano
                            </button>
                        </div>
                    </form>
                </div>
...
<script>
    $(document).ready(function() {
        // Enviar Formulario Nuevo Ciudadanos
        $(document).on('input', '.text-uppercase-input', function() {
            $(this).val($(this).val().toUpperCase());
        });

        $('#formCiudadano').on('submit', function(e) {
            e.preventDefault();
            ...
            $.ajax({
                ...
                success: function(response) {
                    if(response.status === 'success') {
                        window.location.href = 'index.php?toast=success&msg=' + encodeURIComponent('El ciudadano se ha registrado exitosamente.');
                    } else {
                        Swal.fire({
                            icon: 'error',
                            title: 'Error',
