...
require_once '../../core/Catalogo.php';
use Core\Database;

$pdo = Database::getConnection();
$opciones = \Core\Catalogo::getOpciones('tipo_peticion_ventanilla', true);
if (empty($opciones)) {
    $opciones = [
        ['clave' => 'ACTA_FORANEA', 'valor' => 'ACTA FORÁNEA'],
        ['clave' => 'CONSTANCIA', 'valor' => 'CONSTANCIA'],
    ];
}
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2><i class="fa-solid fa-bolt text-warning me-2"></i> Nueva Petición Rápida</h2>
            ...
            <div class="card border-dark border-top border-3">
                <div class="card-body">
                    <form id="formPv">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select" id="tipo_peticion" name="tipo_peticion" required>
                                    ...
                                    <option value="<?php echo htmlspecialchars($op['clave']); ?>"><?php echo htmlspecialchars($op['valor']); ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-12">
                                <label for="detalle" class="form-label fw-bold">Detalle / Referencia</label>
                                <input type="text" class="form-control text-uppercase-input" id="detalle" name="detalle" maxlength="255"
                                       placeholder="EJ: COPIA CERTIFICADA DE ACTA DE NACIMIENTO (TAMAULIPAS) - AÑO 1990" required>
                            </div>
                        </div>

                        <div class="text-end mt-4">
                            <button type="submit" class="btn btn-dark" style="border: none;">
                                <i class="fa-solid fa-paper-plane"></i> Generar Petición
                            </button>
                        </div>
                    </form>
                </div>
...
$(document).ready(function() {
    ...
    new TomSelect("#ciudadano_id", {
        ...
        placeholder: 'Buscar ciudadano por nombre o CURP...',
            ...
            success: function(response) {
                if (response.status === 'success') {
                    Swal.fire({
                        ...
                        html: `Folio: <strong>${response.folio}</strong>`,
