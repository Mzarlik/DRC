...
<head>
    ...
    <title>Actas de InscripciÃ³n - ERP DRC</title>
        ...
        <ul class="list-unstyled components">
            ...
            <li class="<?php echo ($current_module == 'curp') ? 'active' : ''; ?>">
                ...
                <ul class="collapse list-unstyled <?php echo ($current_module == 'curp') ? 'show' : ''; ?>" id="curpSubmenu">
                    <li class="<?php echo ($current_module == 'curp') ? 'index.php' : $path_prefix . 'curp/index.php'; ?>"><i class="fa-solid fa-fingerprint"></i> <span class="sidebar-text">TrÃ¡mites CURP</span></a></li>
                </ul>
            </li>
            <?php endif; ?>
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
                <div>
                    <h2 class="fw-bold mb-1"><i class="fa-solid fa-passport text-primary me-2"></i> Actas de InscripciÃ³n</h2>
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="create.php" class="btn btn-primary fw-bold" style="background: var(--secondary-color); border: none;">
                        <i class="fa-solid fa-plus me-1"></i> Registrar InscripciÃ³n
                    </a>
                </div>
            </div>
            ...
            <ul class="nav nav-pills mb-3" id="inscripcionesTab" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active fw-semibold" id="tab-registros-btn" data-bs-toggle="pill" data-bs-target="#tab-registros" type="button" role="tab">
                        <i class="fa-solid fa-passport me-1"></i> Actas de InscripciÃ³n Registradas
                    </button>
                </li>
                <li class="nav-item" role="presentation">
            ...
            <div class="tab-content" id="inscripcionesTabContent">
                <!-- PestaÃ±a 1: Registros de Inscripciones -->
...
<script>
    $(document).ready(function() {
        ...
        // 1. Tabla de Actas de InscripciÃ³n
        ...
        $('#btnExportExcel').on('click', function() {
            ...
            }, 'Exportando Actas de InscripciÃ³n');
        });
        ...
        const peticionesTable = $('#peticionesInsTable').DataTable({
            ...
            "columns": [
                ...
                { 
                    "data": "tipo_peticion",
                    "render": function(data) {
                        return `<span class="badge bg-light text-dark border" style="font-size: 0.75rem;">INSCRIPCIÃ“N DE ACTA EXTRANJERA</span>`;
                    }
                },
                { 
                    "data": "detalle",
                        ...
                        if (row.estatus === 'PENDIENTE' || row.estatus === 'EN_PROCESO') {
                            html += `
                                <a href="create.php?solicitante=${encodeURIComponent(row.solicitante_nombre)}&curp=${encodeURIComponent(row.solicitante_curp || '')}&folio_origen=${encodeURIComponent(row.folio)}" 
                                    class="btn btn-warning text-dark" title="Atender PeticiÃ³n (Registrar InscripciÃ³n)">
