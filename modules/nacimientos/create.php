    ...
    <div id="content">
        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h2 class="fw-bold mb-1"><i class="fa-solid fa-baby text-primary me-2"></i> Registro de Acta de Nacimiento</h2>
                    <p class="text-muted small mb-0">Captura de libro de actas de nacimiento y vinculación familiar en el padrón</p>
                </div>
            ...
            <div class="alert alert-info">
                <i class="fa-solid fa-circle-info"></i> Nota: El ciudadano (bebé) y los padres deben estar previamente registrados en el <a href="../ciudadanos/create.php" class="alert-link">Catálogo de Ciudadanos</a>.
            </div>
                ...
                <div class="card-body">
                    <form id="formNacimiento">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-4">
                                <label for="lugar_nacimiento" class="form-label fw-bold">Lugar de Nacimiento</label>
                                <input type="text" class="form-control text-uppercase-input" id="lugar_nacimiento" name="lugar_nacimiento" required>
                            </div>
                        </div>

                        <hr>
                        <h5 class="mb-3">Vinculación Familiar</h5>

                        <div class="row mb-3">
                            <div class="col-12 mb-3">
                                <label for="ciudadano_id" class="form-label fw-bold text-primary">Ciudadano Registrado (Bebé)</label>
                                <select id="ciudadano_id" name="ciudadano_id" required placeholder="Buscar por Nombre o CURP..."></select>
                            </div>
                        </div>

                        <div class="row mb-3">
                            <div class="col-md-6">
                                <label for="padre_id" class="form-label fw-bold">Padre (Opcional)</label>
                                <select id="padre_id" name="padre_id" placeholder="Buscar padre..."></select>
                            </div>
                            <div class="col-md-6">
                                <label for="madre_id" class="form-label fw-bold">Madre (Opcional)</label>
                                <select id="madre_id" name="madre_id" placeholder="Buscar madre..."></select>
                            </div>
                        </div>
...
<script>
    $(document).ready(function() {
        ...
        // Configuración de Tom Select para búsqueda AJAX
        ...
        new TomSelect("#ciudadano_id", tomSelectConfig);
        new TomSelect("#padre_id", tomSelectConfig);
        new TomSelect("#madre_id", tomSelectConfig);

        $('#formNacimiento').on('submit', function(e) {
            e.preventDefault();
            ...
            $.ajax({
                ...
                success: function(response) {
                    if(response.status === 'success') {
                        window.location.href = 'index.php?toast=success&msg=' + encodeURIComponent('El acta de nacimiento se ha registrado.');
                    } else {
                        Swal.fire({
                            icon: 'error',
                            title: 'Error',
