...
<head>
    ...
    <title>Actas de Defunción - ERP DRC</title>
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
                <div>
                    <h2 class="fw-bold mb-1"><i class="fa-solid fa-book-skull text-danger me-2"></i> Actas de Defunción</h2>
                ...
                <div class="d-flex gap-2">
                    ...
                    <?php endif; ?>
                    <a href="create.php" class="btn btn-danger fw-bold">
                        <i class="fa-solid fa-plus me-1"></i> Registrar Defunción
                    </a>
                </div>
            </div>
            ...
            <ul class="nav nav-pills mb-3" id="defuncionesTab" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active fw-semibold" id="tab-registros-btn" data-bs-toggle="pill" data-bs-target="#tab-registros" type="button" role="tab">
                        <i class="fa-solid fa-book-skull me-1"></i> Actas de Defunción Registradas
                    </button>
                </li>
                <li class="nav-item" role="presentation">
        ...
        const peticionesTable = $('#peticionesDefTable').DataTable({
            ...
            "columns": [
                ...
                { 
                    ...
                    "render": function(data) {
                        let label = data;
                        if (data === 'REGISTRO_DEFUNCION') label = 'REGISTRO DE DEFUNCIÓN';
                        else if (data === 'ORDEN_INHUMACION_CREMACION') label = 'ORDEN DE INHUMACIÓN / CREMACIÓN';
                        else if (data === 'PASES_CAJA_DEFUNCION') label = 'PASES DE CAJA PARA DEFUNCIÓN';
                        ...
                        if (row.estatus === 'PENDIENTE' || row.estatus === 'EN_PROCESO') {
                            html += `
                                <a href="create.php?solicitante=${encodeURIComponent(row.solicitante_nombre)}&curp=${encodeURIComponent(row.solicitante_curp || '')}&folio_origen=${encodeURIComponent(row.folio)}" 
                                    class="btn btn-warning text-dark" title="Atender Petición (Registrar Defunción)">
