...
<head>
    ...
    <title>Registrar Defunción - ERP DRC</title>
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h2 class="fw-bold mb-1"><i class="fa-solid fa-book-skull text-danger me-2"></i> Registro de Acta de Defunción</h2>
                    <p class="text-muted small mb-0">Asentamiento de defunciones oficiales y actualización de estado vital a FINADO</p>
                </div>
            ...
            <div class="alert alert-warning">
                <i class="fa-solid fa-triangle-exclamation"></i> Al guardar esta acta, el estado vital del ciudadano cambiará automáticamente a <strong>FINADO</strong>. Sólo se muestran ciudadanos activos en la búsqueda.
            </div>
...
<script>
    $(document).ready(function() {
        ...
        // Configuración de Tom Select para búsqueda AJAX (Sólo VIVOS)
