...
<head>
    ...
    <title>Registrar DefunciÃ³n - ERP DRC</title>
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2>Registro de Acta de DefunciÃ³n</h2>
            ...
            <div class="alert alert-warning">
                <i class="fa-solid fa-triangle-exclamation"></i> Al guardar esta acta, el estado vital del ciudadano cambiarÃ¡ automÃ¡ticamente a <strong>FINADO</strong>. SÃ³lo se muestran ciudadanos activos en la bÃºsqueda.
            </div>

            <div class="card border-danger border-opacity-50 border-top border-3">
                <div class="card-body">
                    <form id="formDefuncion">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <label for="ciudadano_id" class="form-label fw-bold text-danger">Ciudadano (Finado)</label>
                                <select id="ciudadano_id" name="ciudadano_id" required placeholder="Buscar ciudadano vivo..."></select>
                            </div>
                        </div>

                        <div class="row mb-3">
                            <div class="col-md-6">
                                <label for="fecha_defuncion" class="form-label fw-bold">Fecha de DefunciÃ³n</label>
                        ...
                        <div class="row mb-3">
                            <div class="col-12">
                                <label for="causa_muerte" class="form-label fw-bold">Causa de Muerte</label>
                                <textarea class="form-control text-uppercase-input" id="causa_muerte" name="causa_muerte" rows="2" required></textarea>
                            </div>
                        </div>
...
<script>
    $(document).ready(function() {
        ...
        // ConfiguraciÃ³n de Tom Select para bÃºsqueda AJAX (SÃ³lo VIVOS)
        new TomSelect("#ciudadano_id", {
            ...
            load: function(query, callback) {
                ...
                $.ajax({
                    ...
                    data: {
                        q: query,
                        estado: 'VIVO' // Filtrar solo vivos
                    },
                    error: function() {
                        callback();
                    },
        ...
        $('#formDefuncion').on('submit', function(e) {
            ...
            Swal.fire({
                ...
                text: 'El estado del ciudadano se actualizarÃ¡ a FINADO permanentemente en el padrÃ³n.',
                icon: 'warning',
                showCancelButton: true,
                confirmButtonColor: 'var(--primary-color)',
                cancelButtonColor: '#6c757d',
                confirmButtonText: 'SÃ­, registrar defunciÃ³n',
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response.status === 'success') {
                                window.location.href = 'index.php?toast=success&msg=' + encodeURIComponent('El acta de defunciÃ³n se ha registrado exitosamente.');
                            } else {
                                Swal.fire({
                                    icon: 'error',
                                    title: 'Error',
