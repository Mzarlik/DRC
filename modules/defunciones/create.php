    ...
    $(document).ready(function() {
        ...
        $('#formDefuncion').on('submit', function(e) {
            ...
            Swal.fire({
                ...
                text: "El estado del ciudadano se actualizará a FINADO permanentemente.",
                icon: 'warning',
                showCancelButton: true,
                confirmButtonColor: '#dc3545',
                cancelButtonColor: '#6c757d',
                confirmButtonText: 'Sí, guardar y actualizar'
            }).then((result) => {
                        ...
                        success: function(response) {
                            if(response.status === 'success') {
                                Swal.fire({
                                    icon: 'success',
                                    title: '¡Registrado!',
                                    text: 'El acta de defunción se ha guardado correctamente.',
