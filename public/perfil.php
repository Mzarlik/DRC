...
try {
    ...
    $stmt = $pdo->prepare("SELECT nombre, correo, rol, creado_en FROM usuarios WHERE id = :id");
...
<head>
    ...
    <title>Perfil de Usuario - ERP DRC</title>
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-4">
                    <div class="card border-0 shadow-sm text-center py-4">
                        <div class="card-body">
                            <img src="https://ui-avatars.com/api/?name=<?php echo urlencode($user['nombre']); ?>&background=18bc9c&color=fff&size=128" class="rounded-circle mb-3 shadow-sm" alt="User Avatar">
                            <h4 class="fw-bold mb-1"><?php echo htmlspecialchars($user['nombre']); ?></h4>
...
$(document).ready(function() {
    ...
    // Form submission: Password Change
