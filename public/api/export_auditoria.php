<?php
// public/api/export_auditoria.php
header('Content-Type: application/json; charset=utf-8');
require_once '../../core/Auth.php';
\Core\Auth::check();
\Core\Auth::checkExport('Auditoria');
...
try {
    ...
    echo json_encode([
        'status' => 'success',
        'job_id' => $jobId,
        'message' => 'La exportación del registro de auditoría se está generando en segundo plano. Te notificaremos cuando esté listo.'
    ]);
    exit;
